...
import SliderDonationWidget from '../components/SliderDonationWidget';
import type { Nonprofit } from '../components/NonprofitSelector';
import { formatCurrency } from '../lib/currency';

const ORDER_TOTAL = 149.99;

export default function SliderCheckoutPage() {
  ...
  return (
    <div className="max-w-[800px] mx-auto">
      ...
      <section className="mb-[24px]">
        <SliderDonationWidget onDonationChange={handleDonationChange} />
      </section>
