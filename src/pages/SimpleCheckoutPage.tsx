  ...
  return (
    <div className="max-w-[800px] mx-auto relative">
      {isSubmitted && (
        <div className="success-overlay">
          <div className="success-checkmark">
            ...
            <p className="success-message font-['Proxima_Nova:Semibold',sans-serif] text-[#0957e8] mt-[24px] text-[18px]">
              Ευχαριστούμε!
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-[12px]">
          ...
          {donationAmount > 0 && (
            <div className="flex justify-between items-center text-[#0957e8]">
              <span className="skeleton-text-blue">Μικρή δωρεά</span>
      ...
      <button 
        ...
        className="w-full h-[52px] bg-[#212121] text-white py-[14px] px-[24px] rounded-[8px] hover:bg-[#1a1a1a] transition-colors disabled:opacity-75 disabled:cursor-not-allowed flex items-center justify-center gap-[8px]"
      >
