...
import CombinedSliderDonationWidgetDE7 from '../components/CombinedSliderDonationWidgetDE7';
import type { Nonprofit } from '../components/NonprofitSelector';
import { formatCurrency } from '../lib/currency';

const ORDER_TOTAL = 149.99;

export default function CombinedSliderCheckoutPageDE7() {
  ...
  return (
    <div className="max-w-[800px] mx-auto">
      ...
      <div className="mb-[24px]">
        <CombinedSliderDonationWidgetDE7 onDonationChange={handleDonationChange} />
      </div>
